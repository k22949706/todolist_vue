<template> 
  <div class="stack-small" v-if="!isEditing">
    ...
    <div class="btn-group">
      ...
      <button type="button" class="btn btn__success"  @click="toggleToItemEditForm">
  ...
  <!-- <to-do-item-edit-form> listens for:
    ...
    Result: itemEdited() method is invoked, which emits the item-edited event (which is then listened for inside App.vue, see above)
    , and sets this.isEditing back to false, so that the edit form is no longer shown on re-render.
